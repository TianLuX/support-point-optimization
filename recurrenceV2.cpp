...
//                cout<<endl;
    ...
    pivots[0] = myEndPivots[0];
    for(int kj=1;kj<k;kj++){
        pivots[kj] = pivots[0]+kj;
    }

    Combination(myassignment,0,k,n,dim,M,coord,pivots,maxDistanceSum,maxDisSumPivots,minDistanceSum,minDisSumPivots);
